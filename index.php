				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<article class="post">
						...
						<div class="post-meta">
							<?php if ( comments_open() ) : ?>
								<span class="comments-link">
									<?php comments_popup_link( __( 'Comment', 'unfold' ), __( '1 Comment', 'unfold' ), __( '% Comments', 'unfold' ) ); ?>
								</span>
							<?php endif; ?>
...
<footer class="site-footer" role="contentinfo">
	<div class="site-info container">
		...
		<a href="http://happypress.co/themes/unfold" rel="theme">UNFOLD</a> by <a href="http://swapnilpatil.in" rel="designer">Swapnil V. Patil</a>
	</div><!-- .site-info -->
